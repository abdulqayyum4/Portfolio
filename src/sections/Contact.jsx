...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          await  emailjs.send("service_sr3kmq8", "template_rdlxadg", {
            from_name: formData.name,
            to_name: "Abdul Qayyum",
            from_email: formData.email,
            to_email:"abdulqayyum200922@gmail.com",
       ...
       {showAlert && <Alert type={alertType} text={alertMessage}/> }
        ...
        <div className="flex flex-col items-start w-full gap-5 mb-10">
            ...
            <form className="w-full" onSubmit={handleSubmit}>
                ...
                <button type="submit"
                className="w-full px-1 py-3 text-lg text-center rounded-sm cursor-pointer bg-radial from-lavender to-royal hover-animation">
