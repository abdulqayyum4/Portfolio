    ...
    <section className='c-space section-spacing' id='about'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='flex items-end grid-default-color grid-1'>
                <img src="assets/coding-pov.png" className='absolute scale-[1.75] -right-20 -top-4 md:scale-[3] md:left-50 md:inset-y-10 lg:scale-[2.5] '/>
                <div className='z-10'>
                    <p className='headtext'>Hi, I'm Abdul Qayyum</p>
                    <p className='subtext'>Over the last 2 years, I developed my frontend and backend skills to deliver  dynamic and responsive software and web applications.</p>
                </div>
                <div className='absolute inset-x-0 pointer-events-none-bottom-4 h-1/2 bg-linear-to-t from-indigo'/>
            </div>
            ...
            <div className='grid-default-color grid-5'>
                <div className='z-10 w-[50%]'>
                    ...
                    <p className='subtext'>I speacialized in a variety of languages, frameworks, andt tools that
